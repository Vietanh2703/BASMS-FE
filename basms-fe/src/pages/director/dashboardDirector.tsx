                ...
                <nav className="dd-sidebar-nav">
                    <ul className="dd-nav-list">
                        <li className="dd-nav-item dd-nav-active">
                            <a href="/director/dashboard" className="dd-nav-link">
                        ...
                        <li className="dd-nav-item">
                            <a href="/director/customer-list" className="dd-nav-link">
                                <svg className="dd-nav-icon" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <li className="dd-nav-item">
                            <a href="/director/analytics" className="dd-nav-link">
                                <svg className="dd-nav-icon" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <li className="dd-nav-item">
                            <a href="/director/reports" className="dd-nav-link">
                                <svg className="dd-nav-icon" viewBox="0 0 24 24" fill="currentColor">
